...
function initScroll() {
  const tl = gsap.timeline({
    scrollTrigger: {
      ...
      pin: true,
      start: "top top",
      // Increase the end value to create a longer scroll distance
      // Multiply by a larger number to create more "stickiness"
      end: () => `+=${items.length * 200}%`, // Changed from 100% to 200%
      scrub: 1.5,
